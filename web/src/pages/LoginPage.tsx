  ...
  return (
    <main className="login-page">
      <section className="login-intro">
        ...
        <p className="eyebrow">Проверяемая оценка проекта</p>
        <h1>От документов к расчёту с проверяемыми источниками.</h1>
        <p>
          Система собирает ВОР, сопоставляет позиции и цены, сохраняет ссылки на
          источники и готовит результат для итогового контроля.
        </p>
        <ol className="login-principles">
          <li>
            <span>01</span>
            ВОР и характеристики из исходных документов
          </li>
          <li>
            <span>02</span>
            ФГИС ЦС, тендеры и рынок с первоисточниками
          </li>
          <li>
            <span>03</span>
            Цена скрыта до обязательных проверок
          </li>
        </ol>
      </section>
